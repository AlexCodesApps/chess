...
const ChessBoard INITIAL_CHESS_BOARD = {
	.slots = {
		W(ROOK),   W(KNIGHT), W(BISHOP), W(KING),   W(QUEEN),  W(BISHOP),
		W(KNIGHT), W(ROOK),   W(PAWN),   W(PAWN),   W(PAWN),   W(PAWN),
		W(PAWN),   W(PAWN),   W(PAWN),   W(PAWN),   E,         E,
		E,         E,         E,         E,         E,         E,
		E,         E,         E,         E,         E,         E,
		E,         E,         E,         E,         E,         E,
		E,         E,         E,         E,         E,         E,
		...
		B(PAWN),   B(PAWN),   B(ROOK),   B(KNIGHT), B(BISHOP), B(KING),
		B(QUEEN),  B(BISHOP), B(KNIGHT), B(ROOK),
	},
	.half_moves = 0,
	.full_moves = 0,
